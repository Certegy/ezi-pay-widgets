export class Config {
    ...
    public static moreInfoUrl = 'https://widgets.certegyezipay.co.nz/content/html/ExternalModal.html';    
    public static baseContentUrl = 'https://images.oxipay.com.au';
    public static priceInfoUrl = 'https://widgets.certegyezipay.co.nz/content/html/PriceInfo.html';
}
